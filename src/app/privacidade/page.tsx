  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <h2 className="text-4xl font-bold mb-8 text-[#444444]">Política Privacidade</h2>
        
        <div className="space-y-6 text-[#444444]">
          <p>
            A sua privacidade é importante para nós. É política do Studiefy respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="https://studiefy.vercel.app" className="text-primary hover:underline">Studiefy</a>, e outros sites que possuímos e operamos.
          </p>
          ...
          <h3 className="text-2xl font-semibold mt-8 mb-4">Compromisso do Usuário</h3>
          <p>
            O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Studiefy oferece no site e com caráter enunciativo, mas não limitativo:
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Studiefy, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
          </ul>
